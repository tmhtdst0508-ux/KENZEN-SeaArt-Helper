...
Sub InitDictionaries()
    ...
    ' C(日本語)とD(英語)... 奇数列を基点に偶数列をペアにする設計
        colArr = Array("A", "E", "G", "I", "K", "M", "O", "Q", "S", "U", "W", "Y", "AA", "AC", "AE", "AG", "AI", "AK", "AM", "AO", "AQ", "AS", "AU", "AW", "AY", "BA", "BC", "BE", "BG", "BI", "BK", "BM", "BO", "BQ", "BS", "BU", "BW", "BY")
...
' 2. AIへのシステムプロンプト
    ...
    sysPrompt = sysPrompt & "You MUST sort all tags strictly in the following order: Art Style -> Camera Angle -> Character Count -> Character Placement -> Relationship -> Skin & Attributes -> Body Type -> Hair length -> Bangs -> Tying -> Hair Color -> Expressions -> Body Hair ->" & _
